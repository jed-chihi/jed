...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["Titre"]) && isset($_POST["Contenu"])) {
        if (!empty($articleId) && !empty($_POST["Titre"]) && !empty($_POST["Contenu"])) {
            // Create an article object
            $article = new Articles($articleId, $_POST["Titre"], $_POST["Contenu"], null);

            // Initialize the controller and update the article
            $articleC = new ArticlesController();
            $articleC->updateArticle($article, $articleId);
...
<body class="Articles-page">
  ...
  <main class="main">
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Articles</h1>
              <p class="mb-0">Update your article below.</p>
            </div>
          </div>
        </div>
      </div>
    ...
    <!-- Articles Section -->
    <section id="Articles" class="contact section">
      <div class="container">
        ...
        <form method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="300">
          <div class="row gy-4">
            ...
            <div class="col-md-12 text-center">
              ...
              <div class="sent-message">Your Article has been updated. Thank you!</div>
