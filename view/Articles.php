...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    if (isset($_POST["Titre"]) && isset($_POST["Contenu"])) {
        if (!empty($_POST["Titre"]) && !empty($_POST["Contenu"])) {
            ...
            $article = new Articles(null, $_POST["Titre"], $_POST["Contenu"], null);
      ...
      <div class="heading">
        <div class="container">
          <div class="row d-flex justify-content-center text-center">
            <div class="col-lg-8">
              <h1>Articles</h1>
              <p class="mb-0">Welcome to our page. Please submit your article below.</p>
            </div>
          </div>
        </div>
      </div>
      ...
      <div class="container">
        ...
        <form method="post" class="php-email-form" data-aos="fade-up" data-aos-delay="300">
          <div class="row gy-4">
            ...
            <div class="col-md-12">
              <textarea class="form-control" name="Contenu" rows="10" placeholder="Contenu" required></textarea>
            </div>
            <div class="col-md-12 text-center">
              <div class="loading">Loading</div>
              <div class="error-message"></div>
              <div class="sent-message">Your Article has been submitted. Thank you!</div>
